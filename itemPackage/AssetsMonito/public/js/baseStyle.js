...
var contentText = '<div class="content-leftBox content-boxItem">'
...
var base = {
	...
	base.queryBoxDisplay = function(){
		...
		$(base.li).click(function(event){
		    ...
		    $(base.queryBox).css({'top':$(this).offset().top}).slideDown().attr('data-id',$(this).attr('id'));
		})
	}
	...
	if(typeof this.addSpan != 'function'){
		this.addSpan = function(){
			...
			$(Attributes.doms[count]).parent().append((function(){
				...
				if(field == '目标金额'){
					var span = $('<span class="addSpan"><span>'+field+'</span><i data-value="'+goalData[0]['总人数']+'">'+Math.round(goalData[0]['总金额']/10000)+'</i></span>');
				}else{
